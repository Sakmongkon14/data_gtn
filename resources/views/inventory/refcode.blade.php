        ...
        <div class="content" style="transition: margin-left 0.3s ease-in-out; padding-top: 40px;">
            ...
            <div class="container">
                <form action="/addrefcode" method="POST" enctype="multipart/form-data" id="csvForm"
                    ...
                    <input type="submit" class="btn btn-primary" name="preview_add"
                        value="แสดงข้อมูล Refcode ที่ต้องการเพิ่ม" data-bs-toggle="modal"
                        data-bs-target="#exampleModal"style="font-size: 10px;">
                </form>
            </div>

            <div class="container col-12 my-3">
                <form action="/addrefcodemanual" method="POST" class="d-flex align-items-center gap-2"
                    style="justify-content: center;">
                    @csrf
                    <!-- Input Fields -->

                    <!-- Refcode -->
                    <input style="font-size: 12px; width: 200px;" type="text" name="refcode"
                        class="form-control @error('refcode') is-invalid @enderror" id="refcode"
                        placeholder="@error('refcode') {{ $message }}  @else Refcode @enderror"
                        value="{{ old('refcode') }}">


                    <!-- Description -->
                    <input style="font-size: 12px; width: 300px;" type="text" name="description"
                        class="form-control @error('description') is-invalid @enderror" id="description"
                        placeholder="@error('description') {{ $message }} @else Description @enderror"
                        value="{{ old('description') }}">


                    <!-- Submit Button -->
                    <input style="font-size: 10px;" class="btn btn-primary" type="submit"
                        onclick="confirmAddrefcode(event)" value="ADD Refcode">
            ...
            @if (!empty($dataToSave) && (is_array($dataToSave) || is_object($dataToSave)))
                <div class="modal fade show d-block" id="refcodeModal" tabindex="-1" role="dialog"
                    aria-labelledby="refcodeModalLabel" aria-hidden="true"
                    style="background-color: rgba(0, 0, 0, 0.5);">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="refcodeModalLabel" style="font-size: 15px;">ตรวจสอบข้อมูล
                                    Refcode</h5>
                                <input placeholder=" " class="input-style" type="text" id="refcodeSearch"
                                    name="refcodeSearch">
                                            ...
                                            @foreach ($dataToSave as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <span style="color: green;">สามารถ Upload refcode
                                                                ได้</span>
                                                        @endif
                                                    </td>
                                                </tr>
            ...
            <div class="container mt-5">
                <div class="table-wrapper">
                    <div class="texeadd">
                        <div class="hi">
                            <h3 class="mb-4" style="display: flex; gap:7px">Refcode<i
                                    class="fa-solid fa-file-code"></i></h3>
                        </div>
                            ...
                            <thead style="font-size: 12px; text-align:center">
                                <tr>
                                    ...
                                    <th scope="background-color: skyblue;"
                                        style="width: 20rem; text-align: center; vertical-align: middle;">
                                        RefCode
                                        <div
                                            style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                            <input class="input-style" type="text" id="searchRefCode"
                                                name="searchRefCode"
                                    ...
                                    <th scope="background-color: skyblue;"
                                        ...
                                        <div
                                            style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                            <input class="input-style" type="text" id="searchDescription"
