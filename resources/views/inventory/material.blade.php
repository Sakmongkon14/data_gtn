...
<body>
    ...
    <section class="home-section">
        ...
        <div class="content" style="transition: margin-left 0.3s ease-in-out; padding-top: 40px;">
            ...
            <!-- แสดงข้อความสำเร็จ -->
            @if (session('success'))
                <div class="alert alert-success" style="margin: 20px; font-size: 12px; padding: 10px; width: 250px;">
                    {{ session('success') }}
                </div>
            @endif
            ...
            <div class="container col-12 my-3">
                <form action="/addmaterialmanual" method="POST" class="d-flex align-items-center gap-2"
                    ...
                    <!-- Price -->
                    <input style="font-size: 12px; width: 100px;" type="number" name="price"
                    ...
                    <script>
                        function confirmAddrefcode(event) {
                            // แสดงกล่องยืนยัน
                            var userConfirmed = confirm("คุณต้องการ ADD Material หรือไม่?");
                        ...
                        <table class="table" id="table">
                            <thead style="font-size: 12px; text-align:center">
                                ...
                                <tr>
                                    ...
                                    <th style="background-color: skyblue; align-content: space-around;">Price</th>
